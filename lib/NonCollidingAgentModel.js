...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let milks1 = new NonCollidingArea('rightPole', Math.ceil((5/23)*numRows), 3, grid,"images/milks.png",bottomMiddle,scale(12),1);
  let cashier2 = new NonCollidingArea('rightPole', scale(2), 2, grid,"images/Cashier3.png",bottomMiddle,scale(8),6);
  let milks2 = new NonCollidingArea('rightPole', Math.ceil((5/23)*numRows), 3, grid,"images/milks.png",bottomMiddle,scale(12),6);
  ...
  let milks3 = new NonCollidingArea('rightPole', Math.ceil((5/23)*numRows), 3, grid,"images/milks.png",bottomMiddle,scale(12),11);
 ...
 ;
  ...
  let tree =  new NonCollidingArea('rightPole', scale(2), 2, grid,"images/gingerbread-man.png",bottomLeft,scale(4),22);
  ...
  let ginger= new NonCollidingArea('open', scale(2), 2, grid,"images/christmas-tree.png",topMiddle,scale(4),14);
...
fruit1,fruit2,vegetable1,meat,seafood,fridge1,fridge2,fridge3,bread2]*///,trolley1,trolley2,trolley3,trolley4,trolley5,trolley6,trolley7,trolley8,trolley9
  ...
  bread2,fridge1,fridge2,fridge3,shelvesitems1,shelvesitems2,shelvesitems3,shelvesitems4,toysMachine,ginger]
  //areas = [rightPole]
