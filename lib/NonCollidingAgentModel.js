...
class Static {
	constructor(type, label, row, col, url, state = IDLE) {
        this.type = type
        this.label = label;
        this.location = {
            "row": row,
...
let doctor = new Static(1,'Doctor',doctorRow,doctorCol,"images/cashier.png")
let receptionist = new Static(2,'Receptionist',receptionistRow,receptionistCol,"images/cashier.png")
let trolley = new Static(3,'Trolley',3,4,"images/trolley.png")
let milk = new Static(4,'Milk',3,6,"images/milk.png")
let cheese = new Static(5,'Cheese',4,6,"images/cheese.png")
let staticList = [doctor,trolley,milk,cheese]
...
(function() {
	...
	document.getElementById("title").textContent = "Chong Yu Kai"
	redrawWindow();
})();
...
function redrawWindow(){
	...
	let waitingRoom = new Area('Waiting Area', 4, 3, 19, 3, 'pink');
	let stagingRoom = new Area('Staging Area', doctorRow - 1, 1, doctorCol - 2, 5, 'red');
	console.log(grid.locations);
	let block1 = new NonCollidingArea('Block 1', 3, 7, 6, 2, grid);
	let block2 = new NonCollidingArea('Block 1', 12, 7, 6, 2, grid);
	let block3 = new NonCollidingArea('Block 1', 3, 10, 12, 2, grid);
	let block4 = new NonCollidingArea("Block 4", 12, 2, 30, 6, grid);

	areas = [waitingRoom, stagingRoom, block1, block2, block3, block4];
...
function updateSurface(){
	...
	newpatients.append("svg:image")
	 ...
	 .attr("xlink:href",function(d){if (d.type=="A") return urlCustomerA; else return urlCustomerB;});// Possible to change this to include two images
...
function addDynamicAgents(){
	...
	if (Math.random()< probArrival){
		...
		let newpatient = new NonCollidingAgent(1, "A", initialRow, 1, grid);
