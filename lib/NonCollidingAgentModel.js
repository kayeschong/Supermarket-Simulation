...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let cashier1 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+14, 1.5, grid,"images/cashier3.png");
  let cashier2 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+18, 1.5, grid,"images/cashier3.png");
  let cashier3 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+22, 1.5, grid,"images/cashier3.png");
  ...
  //let cashierArea =new Area("CashierArea", lastBlockRow+5, 2, firstBlockCol+12, 25, grid,"images/cashier_floor.png");
	...
	areas = [walls,light1,oats,bread,directions,meat,cashier1,cashier2,cashier3,seafood,detergent1,detergent2,fruits,vegetables,open,cheese2
