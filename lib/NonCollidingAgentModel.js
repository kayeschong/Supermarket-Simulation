...
function redrawWindow(){
	...
	console.log(grid.locations);
	let block1 = new NonCollidingArea('Block 1', 3, 7, 6, 2, grid,"images/archive.png");
	let block2 = new NonCollidingArea('Block 1', 12, 7, 6, 2, grid,"images/archive.png");
	let block3 = new NonCollidingArea('Block 1', 2, 3,10, 5, grid,"images/meat.png");
	let block4 = new NonCollidingArea("Block 4", 12, 2, 30, 6, grid,"images/archive.png");

	areas = [block1, block2, block3];


	let doctor = new Static(1,'Doctor',doctorRow,doctorCol,"images/cashier.png",grid)
	let receptionist = new Static(2,'Receptionist',receptionistRow,receptionistCol,"images/cashier.png",grid)
	let trolley1 = new Static(3,'Trolley',3,4,"images/trolley.png",grid)
	let trolley2 = new Static(3,'Trolley',5,4,"images/trolley.png",grid)
	let trolley3 = new Static(3,'Trolley',7,4,"images/trolley.png",grid)
	let milk = new Static(4,'Milk',3,6,"images/milk.png",grid)
	let cheese = new Static(5,'Cheese',4,6,"images/cheese.png",grid)
	staticList = [doctor,trolley1,trolley2, trolley3, milk,cheese]
