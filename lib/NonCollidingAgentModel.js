...
function redrawWindow(){
  ...
  const lastBlockRow = firstBlockRow+14
	...
	console.log(grid.locations);
	let block1 = new NonCollidingArea('Block 1', firstBlockRow+5, 7, firstBlockCol, 2, grid,"images/archive.png");
	let block2 = new NonCollidingArea('Block 1', firstBlockRow+14, 7, firstBlockCol, 2, grid,"images/archive.png");
  let block3 = new NonCollidingArea('Block 1', firstBlockRow+5, 7, firstBlockCol+7, 2, grid,"images/archive.png");
	let block4 = new NonCollidingArea('Block 1', lastBlockRow, 7, firstBlockCol+7, 2, grid,"images/archive.png");
	let meat = new NonCollidingArea('Block 1', firstBlockRow, 3,firstBlockCol, 5, grid,"images/meat.png");
  let seafood = new NonCollidingArea('Block 1', firstBlockRow, 3,firstBlockCol+7, 5, grid,"images/seafood.png");
  let oats = new NonCollidingArea('Block 1', firstBlockRow+5, 6,firstBlockCol+14, 5, grid,"images/oats.png");
  let bread = new NonCollidingArea('Block 1', firstBlockRow+5, 6,firstBlockCol+21, 5, grid,"images/bread.png");
  let detergent = new NonCollidingArea('Block 1', firstBlockRow+5, 6,firstBlockCol+28, 5, grid,"images/detergent.png");
  ...
  let cashier3 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+22, 1.5, grid,"images/cashier_self.png");
	...
	areas = [block1, block2, block3,block4,meat,cashier1,cashier2,cashier3,seafood,oats,bread,detergent];

  const firstItemRow = firstBlockRow+5
  const firstItemCol = firstBlockCol
	...
	let trolley1 = new Static(3,'Trolley',firstBlockRow+23,firstBlockCol,"images/trolley.png",grid)
	let trolley2 = new Static(3,'Trolley',firstBlockRow+23,firstBlockCol+1,"images/trolley.png",grid)
	let trolley3 = new Static(3,'Trolley',firstBlockRow+23,firstBlockCol+2,"images/trolley.png",grid)
  let trolley4 = new Static(3,'Trolley',firstBlockRow+24,firstBlockCol,"images/trolley.png",grid)
  let trolley5 = new Static(3,'Trolley',firstBlockRow+24,firstBlockCol+1,"images/trolley.png",grid)
  let trolley6 = new Static(3,'Trolley',firstBlockRow+24,firstBlockCol+2,"images/trolley.png",grid)
  ...
  let drinks = new Static(4,'Drinks',firstItemRow,firstItemCol+2,"images/signboard.png",grid)
	staticList = [trolley1,trolley2, trolley3,trolley4,trolley5, trolley6, milk,cheese,drinks]
