...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let cashier1 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+14, 1.5, grid,"images/cashiernew.png");
  let cashier2 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+18, 1.5, grid,"images/cashiernew.png");
...
,drinks2,drinks3,bread2,sauces3,clothes1,clothes2,middleCold,iceCream,snowGlobe,tree,snowman];
