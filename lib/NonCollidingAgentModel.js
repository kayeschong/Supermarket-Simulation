...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let directions = new NonCollidingArea('Block 1', lastBlockRow-3, 3, firstBlockCol+11, 2, grid,"images/directions.png");
	let meat = new NonCollidingArea('Block 1', firstBlockRow, 3,firstBlockCol+14, 5, grid,"images/meat.png");
  let seafood = new NonCollidingArea('Block 1', firstBlockRow, 3,firstBlockCol+22, 5, grid,"images/seafood.png");
  ...
  let open = new NonCollidingArea("open", firstBlockRow+25, 3, firstBlockCol, 3, grid,"images/open.png");
	...
	areas = [block1, block2, block3,block4,directions,meat,cashier1,cashier2,cashier3,seafood,oats,bread,detergent,fruits,vegetables,open];
  ...
  let basket = new Static(4,'Basket',firstBlockRow+2,firstBlockCol+3,"images/basket.png",grid)
	staticList = [trolley1,trolley2, trolley3,trolley4,trolley5, trolley6, milk,cheese,drinks,basket]
