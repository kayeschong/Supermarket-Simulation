...
function insertPosition(relativePosition,addRow,addCol){
...
class NonCollidingArea  {
    ...
    this.grid.fillLocations(this.position.startRow, this.numRows, this.position.startCol, this.numCols);
...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let walls = new NonCollidingArea('Walls',4,maxCols ,grid,"images/shelves1.png",topLeft,0,0);

  let rightPole = new NonCollidingArea('rightPole', 7, 4, grid,"images/pole1.png",bottomRight,10,14);
  let leftPole = new NonCollidingArea('rightPole', 7, 4, grid,"images/pole2.png",bottomMiddle,10,0);
  let cashier1 = new NonCollidingArea('rightPole', 2, 2, grid,"images/cashier3.png",bottomMiddle,8,2);
  let cashier2 = new NonCollidingArea('rightPole', 2, 2, grid,"images/cashier3.png",bottomMiddle,8,6);
  let cashier3 = new NonCollidingArea('rightPole', 2, 2, grid,"images/cashierself.png",bottomMiddle,8,11);
  let bag1 = new NonCollidingArea('rightPole', 1, 0.8, grid,"images/bags.png",bottomMiddle,7,1);
  let bag2 = new NonCollidingArea('rightPole', 1, 0.8, grid,"images/bags.png",bottomMiddle,7,5);
  let bag3 = new NonCollidingArea('rightPole', 1, 0.8, grid,"images/bags.png",bottomMiddle,7,10);

  let trolley1 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomMiddle,3,0);
  let trolley2 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomMiddle,3,1);
  let trolley3 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomMiddle,3,2);
 ...
 ;
  ...
  //EntranceArea
  let open = new NonCollidingArea('open', 3, 3, grid,"images/open.png",bottomLeft,5,3);
  let trolley4 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,4,9);
  let trolley5 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,3,9);
  let trolley6 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,4,7);
  let trolley7 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,3,7);
  let trolley8 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,4,8);
  let trolley9 = new NonCollidingArea('rightPole', 1, 1, grid,"images/trolley2.png",bottomLeft,3,8);
  let iceCream = new NonCollidingArea('rightPole', 2, 2, grid,"images/iceCream.png",bottomLeft,4,17);
  let entrance1 = new NonCollidingArea('rightPole', 2, 2, grid,"images/barrier.png",bottomLeft,4,10);
  let entrance2= new NonCollidingArea('rightPole', 2, 2, grid,"images/barrier.png",bottomLeft,4,15);
  let snowGlobe =  new NonCollidingArea('rightPole', 3, 3, grid,"images/snow-globe.png",bottomLeft,5,19);
  let snowman=  new NonCollidingArea('rightPole', 2, 2, grid,"images/snowman.png",bottomLeft,4,21);
  let tree =  new NonCollidingArea('rightPole', 3, 2, grid,"images/christmas-tree.png",bottomLeft,5,22);
  ...
  //clothesArea
  let direction = new NonCollidingArea('open', 3, 2, grid,"images/directions.png",topMiddle,7,0);
  let clothes1 = new NonCollidingArea('open', 4, 5, grid,"images/clothes1.png",topMiddle,5,9);
  let clothes2 = new NonCollidingArea('open', 2, 4, grid,"images/clothes2.png",topMiddle,7,14);

  //Walls
  let fruit1 = new NonCollidingArea('open', 2, 3, grid,"images/fruits3.png",topLeft,2,3);
  let fruit2 = new NonCollidingArea('open', 2, 3, grid,"images/Fruit.png",topLeft,2,8);
  ...
  let fridge1 = new NonCollidingArea('open', 3, 2, grid,"images/cheese2.png",topRight,1,12);
  let fridge2 = new NonCollidingArea('open', 3, 2, grid,"images/drinks2.png",topRight,1,10);
  let fridge3 = new NonCollidingArea('open', 3, 2, grid,"images/drinks3.png",topRight,1,8);
  let bread2 = new NonCollidingArea('open', 3, 2, grid,"images/bread2.png",topRight,1,14);
  let shelvesitems1 = new NonCollidingArea('open', 0.6, 2, grid,"images/shelvesItems2.png",topRight,2,17);
  let shelvesitems2 = new NonCollidingArea('open', 0.7, 2, grid,"images/shelvesItems2.png",topRight,2,19);
  let shelvesitems3 = new NonCollidingArea('open', 0.7, 2, grid,"images/shelvesItems2.png",topRight,3,17);
  let shelvesitems4 = new NonCollidingArea('open', 0.7, 2, grid,"images/shelvesItems2.png",topRight,3,19);
...
fruit1,fruit2,vegetable1,meat,seafood,fridge1,fridge2,fridge3,bread2]*/
  ...
  snowGlobe,snowman,tree,entrance1,entrance2,oats,detergent1,detergent2,roundSauces,bread,direction, clothes1,clothes2,fruit1,fruit2,vegetable1,seafood,meat,
