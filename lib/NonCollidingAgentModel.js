...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let rightPole = new NonCollidingArea('rightPole',Math.floor((10/21)*numRows), 4, grid,"images/pole1.png",bottomRight,Math.floor((13/21)*numRows),14);
  let leftPole = new NonCollidingArea('rightPole', Math.floor((10/21)*numRows), 4, grid,"images/pole2.png",bottomMiddle,scale(13),0);
  let cashier1 = new NonCollidingArea('rightPole', Math.floor((2/21)*numRows), 2, grid,"images/Cashier3.png",bottomMiddle,scale(8),1);
  let cashier2 = new NonCollidingArea('rightPole', scale(2), 2, grid,"images/Cashier3.png",bottomMiddle,scale(8),6);

  let mistletoe = new NonCollidingArea('rightPole', scale(2), 3, grid,"images/mistletoe.png",bottomMiddle,scale(13),5);
  let snowGlobe =  new NonCollidingArea('rightPole', scale(3), 3, grid,"images/snow-globe.png",bottomMiddle,scale(11),5);

  let snowman =  new NonCollidingArea('rightPole', scale(2), 2, grid,"images/snowman.png",bottomMiddle,scale(10),7);
...
fruit1,fruit2,vegetable1,meat,seafood,fridge1,fridge2,fridge3,bread2]*///,trolley1,trolley2,trolley3,trolley4,trolley5,trolley6,trolley7,trolley8,trolley9
  ...
  snowGlobe,tree,snowman,entrance1,entrance2,oats,detergent1,detergent2,roundSauces,bread,direction, clothes1,clothes2,fruit1,fruit2,vegetable1,vegeMachine,seafood,meat,mistletoe,cottonCandy,popcorn,rotate,//,water,popcorn,
  bread2,fridge1,fridge2,fridge3,shelvesitems1,shelvesitems2,shelvesitems3,shelvesitems4,toysMachine]
  //areas = [rightPole]
