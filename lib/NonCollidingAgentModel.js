...
function redrawWindow(){
  ...
  let block3 = new NonCollidingArea('Block 1', firstBlockRow+5, 7, firstBlockCol+7, 2, grid,"images/archive.png");
	...
	let block5 = new NonCollidingArea("Block 4", 12, 2, 30, 6, grid,"images/archive.png");
  ...
  let cashier3 = new NonCollidingArea("Cashier", lastBlockRow+5, 1.5, firstBlockCol+22, 1.5, grid,"images/cashier_self.png");
	...
	areas = [block1, block2, block3,block4,meat,cashier1,cashier2,cashier3];
  ...
  const firstItemCol = firstBlockCol
	...
	staticList = [trolley1,trolley2, trolley3, milk,cheese]
