...
//	drawsurface.style.border = "thick solid #0000FF"; //The border is mainly for debugging; okay to remove it
  ...
  let walls = new NonCollidingArea('Walls',4,maxCols-1 ,grid,"images/shelves1.png",topLeft,0,0);
  //CashierArea
  ...
  let iceCream = new NonCollidingArea('rightPole', 2, 2, grid,"images/iceCream.png",bottomRight,4,0);
  ...
  //clothesArea
  let direction = new NonCollidingArea('open', 3, 2, grid,"images/directions.png",topMiddle,3,5);
